...
Строки в верхнем и нижнем регистре с одиаковыми символами считаются совпадающими.
...
def is_array_string_are_equal(array_string_1: list[str], array_string_2: list[str]) -> bool:
    array_string_1 = "".join(array_string_1).lower()
    array_string_2 = "".join(array_string_2).lower()
    answer = (array_string_1 == array_string_2)
